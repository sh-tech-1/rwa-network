...
function Services02(props) {
    ...
    const [dataBlock] = useState(
        {
            heading: 'Why choose Coffee',
            desc : 'Coffee has a variety of features that make it the best place to start trading'
        }
    )
        ...
        <div className="container">
            ...
            <div className="col-xl-6 col-md-12">
                ...
                <div className="crypto-box">
                    <img className="arrow" src={arrow} alt="Coffee" />
                    <div className="left">
                    <img src={bitcoin} alt="Coffee" />
                    <div>
                        <h6>BTC</h6>
                        <p>+1.46%</p>
                    </div>
                    ...
                    <img src={chart} alt="Coffee" />
                    </div>
                </div>
                <div className="shape"></div>
                <div className="user-card">
                    <div className="info">
                    <img src={avt} alt="Coffee" />
                    <h6>Esther Howard</h6>
